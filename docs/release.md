...
This guide prepares WorkCue for `v0.1.0-alpha.3` developer preview releases. It avoids local paths, token values, private vault data, and generated briefs in Git.
...
```bash
npm deprecate workcue@0.1.0-alpha.3 "Use the next alpha release."
```
